...
# -*- coding: utf-8 -*-
"""
Created on Fri Dec 30 18:34:45 2016
...
import pandas as pd
import sys
sys.path.append('/home/pascal/Python')
from DX import *
#%%
...
class derivatives_portfolio(object):
    ...
    def __init__(self, name, positions, val_env, assets, 
        ...
        if correlations is not None:
            ...
            self.val_env.add_constant('cholesky_matrix', cholesky_matrix)
            ...
            self.val_env.add_list('sholesky_matrix', cholesky_matrix)
